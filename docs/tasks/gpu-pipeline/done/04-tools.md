...
Закрыт **4a + GL-мост** (пункты 1–4). 4b и пункты 5–6 — [`04b-gpu-stamps.md`](../04b-gpu-stamps.md).
...
[`04b-gpu-stamps.md`](../04b-gpu-stamps.md): штампы на GPU, маска-шейдер, штамп сэмплит текстуру.

### Следующая задача

[`05-cook-graph.md`](../05-cook-graph.md). 4b — когда понадобятся штампы на GPU.
