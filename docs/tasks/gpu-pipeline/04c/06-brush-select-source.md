...
В UI тип кисти тоже называется «выдел-е» — это `EBrushType.Select` (штамп пикселей из области), не обрезка любого штриха — то [`../done/04c-01-selection-clip.md`](../done/04c-01-selection-clip.md).
